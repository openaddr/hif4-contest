...
# --- attention-side lattice refinement (exploration; default OFF = v33 path) ---
...
ATTN_REFINE_Q_SWEEPS = 0    # sweeps for dynamic Q (1 sweep = 20 greedy rounds)
ATTN_REFINE_K_SWEEPS = 0    # sweeps for dynamic K
...
_REF_ATTN_ROUNDS = REFINE_ROUNDS  # rounds per sweep (bench override hook)
